...
select category as `Product category`, sum(price) as `Total revenue`
from products
group by category;


# 6. What is the average price of products in the 'food' category?
select avg(price) as `Average food price`
from products 
where category='food';

#7. How many orders were made in each sales channel (sales_channel column) in the orders table?
select sales_channel, count(order_id) as `No.of orders`
from orders
